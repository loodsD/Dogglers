...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val dogHobbyText : TextView? = view!!.findViewById(R.id.dog_hobby)

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        val adapaterLayout = when(layout){
        ...
        return DogCardViewHolder(adapaterLayout)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogNameText?.text = data.name
        // TODO: Set the text for the current dog's age
        holder.dogAgeText?.text = data.age
        val resources = context?.resources
        holder.dogHobbyText?.text = resources?.getString(R.string.dog_hobbies,data.hobbies)
